            ...
            <div class="bg-white rounded-3xl shadow-2xl border border-slate-100 p-6">
                ...
                <form action="{{ route('bills.check') }}" method="GET" class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="provider" required class="w-full bg-slate-50 hover:bg-slate-100 border-2 border-slate-200 rounded-xl px-4 py-4 text-sm font-semibold text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 transition-all">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="tel" name="reference_number" placeholder="Enter your consumer number" required class="block w-full bg-slate-50 hover:bg-slate-100 border-2 border-slate-200 rounded-xl py-4 pl-12 pr-4 text-sm font-semibold text-slate-900 placeholder:text-slate-400 placeholder:font-normal focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 transition-all">
                        </div>
                    </div>
                    ...
                    <button type="submit" class="w-full relative overflow-hidden rounded-xl bg-gradient-to-r from-red-600 to-rose-600 py-4 text-sm font-bold text-white shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-200 active:scale-[0.98] group">
