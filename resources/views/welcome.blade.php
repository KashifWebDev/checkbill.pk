...
<body class="premium-mesh text-slate-600 antialiased selection:bg-green-500/20 selection:text-green-700 relative min-h-screen flex flex-col">
    ...
    @php
        $providerLogos = [
            'iesco' => asset('storage/img/iesco.png'),
