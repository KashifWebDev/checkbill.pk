<html lang="en" class="scroll-smooth"><head>
    ...
    <title>PakBills - Instant Duplicate Bill Checker</title>
    <meta name="description" content="Check electricity and gas bills in Pakistan. IESCO, LESCO, KE, SNGPL. Official duplicate bill source.">
...
<body class="premium-mesh text-slate-600 antialiased selection:bg-green-500/20 selection:text-green-700 relative min-h-screen flex flex-col">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <a href="#" class="flex items-center gap-2.5 group">
                ...
                <div class="flex flex-col">
                    <span class="text-base font-bold tracking-tight text-slate-900 leading-none">PakBills</span>
                    <span class="text-[10px] font-medium text-slate-500 uppercase tracking-wider mt-0.5">Duplicate Bill Source</span>
                </div>
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#app" class="hidden md:inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-2 text-xs font-semibold text-white shadow-lg shadow-slate-900/10 hover:bg-slate-800 hover:scale-105 transition-all duration-300">
    ...
    <main class="flex-grow pt-32 pb-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div class="max-w-2xl mx-auto text-center animate-fade-up">
            ...
            <p class="text-base sm:text-lg text-slate-500 mb-10 max-w-lg mx-auto leading-relaxed">
        ...
        <div id="app" class="max-w-md mx-auto animate-fade-up delay-100">
            <div class="relative bg-white rounded-3xl shadow-[0_20px_60px_-10px_rgba(0,0,0,0.1)] border border-slate-100 p-2 z-10">
                ...
                <div class="flex p-1 bg-slate-50 rounded-2xl mb-4 border border-slate-100/50">
                    <button class="flex-1 py-2.5 text-xs font-bold rounded-xl bg-white text-slate-900 shadow-sm ring-1 ring-slate-900/5 transition-all flex items-center justify-center gap-2">
                        <iconify-icon icon="lucide:zap" width="14" class="text-orange-500"></iconify-icon>
                        Electricity
                    </button>
                    <button class="flex-1 py-2.5 text-xs font-medium rounded-xl text-slate-500 hover:text-slate-900 transition-all flex items-center justify-center gap-2">
                ...
                <form action="/check" method="GET" class="px-4 pb-4 pt-2">
                    ...
                    <div class="mb-5 relative z-50">
                        ...
                        <div class="custom-select relative">
                            ...
                            <div class="custom-select-options absolute top-full left-0 right-0 mt-2 bg-white border border-slate-100 rounded-2xl shadow-xl py-2 z-50">
                                ...
                                <!-- Option: LESCO -->
                                <div onclick="selectProvider('lesco', 'LESCO', 'LE', 'bg-orange-100 text-orange-600')" class="px-3 py-2.5 mx-2 rounded-xl hover:bg-slate-50 cursor-pointer flex items-center justify-between group transition-colors">
                                    <div class="flex items-center gap-3">
                                ...
                                <!-- Option: K-Electric -->
                                <div onclick="selectProvider('ke', 'K-Electric', 'KE', 'bg-blue-100 text-blue-600')" class="px-3 py-2.5 mx-2 rounded-xl hover:bg-slate-50 cursor-pointer flex items-center justify-between group transition-colors">
                                    <div class="flex items-center gap-3">
                                ...
                                <!-- Option: IESCO -->
                                <div onclick="selectProvider('iesco', 'IESCO', 'IE', 'bg-green-100 text-green-600')" class="px-3 py-2.5 mx-2 rounded-xl hover:bg-slate-50 cursor-pointer flex items-center justify-between group transition-colors">
                                    <div class="flex items-center gap-3">
                                ...
                                <!-- Option: SNGPL -->
                                <div onclick="selectProvider('sngpl', 'SNGPL', 'SN', 'bg-indigo-100 text-indigo-600')" class="px-3 py-2.5 mx-2 rounded-xl hover:bg-slate-50 cursor-pointer flex items-center justify-between group transition-colors">
                                    <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 mb-6 ml-1">
                        <input type="checkbox" id="save-bill" class="w-4 h-4 rounded border-slate-300 text-green-600 focus:ring-green-500 cursor-pointer accent-green-600">
                        <label for="save-bill" class="text-xs text-slate-600 select-none cursor-pointer">Save this bill for next time</label>
                    </div>
            ...
            <div class="mt-8 grid grid-cols-2 gap-4">
                <a href="#" class="flex items-center justify-center gap-2 p-3 rounded-xl bg-green-50 border border-green-100 hover:border-green-200 transition-colors group">
                    <iconify-icon icon="lucide:message-circle" width="18" class="text-green-600 group-hover:scale-110 transition-transform"></iconify-icon>
                    <span class="text-xs font-semibold text-green-800">WhatsApp Help</span>
                </a>
                <a href="#" class="flex items-center justify-center gap-2 p-3 rounded-xl bg-white border border-slate-100 hover:border-slate-200 transition-colors shadow-sm group">
                    <iconify-icon icon="lucide:bell" width="18" class="text-slate-400 group-hover:text-slate-600 transition-colors"></iconify-icon>
                    <span class="text-xs font-semibold text-slate-600">Load Shedding</span>
                </a>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto mt-24 mb-10">
            <h2 class="text-lg font-bold text-center text-slate-900 mb-10">Why use PakBills?</h2>
    ...
    <footer class="bg-white border-t border-slate-200">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-xs text-slate-400">© 2024 PakBills. Made with ❤️ in Pakistan.</p>
